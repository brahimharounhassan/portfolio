...
console.log('\n📋 ÉTAPES DE MIGRATION :')
console.log('1. Créer un nouveau repository sur GitHub avec le nom : elbramos.github.io')
...
console.log('git remote add main-domain https://github.com/brahimharounhassan/elbramos.github.io.git')
console.log('')
...
console.log('\n🌐 RÉSULTAT :')
console.log('✅ Portfolio accessible sur : https://elbramos.github.io')
console.log('✅ Plus besoin de /portfolio à la fin de l\'URL')
console.log('✅ GitHub Actions configuré pour déploiement automatique')

console.log('\n⚠️  ATTENTION :')
console.log('- Le repository doit s\'appeler exactement : elbramos.github.io')
